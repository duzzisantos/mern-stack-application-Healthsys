...
const PatientsTable = () => {
  ...
  const handleDeleteById = (_id) => {
    axios
      .delete(`http://localhost:4000/api/patients/${_id}`)
      .then((response) => {
        ...
        <Table sx={{ minWidth: 700 }} aria-label="customized table">
          <TableHead>
            <TableRow>
              ...
              <StyledTableCell align="right">N.O.K</StyledTableCell>
              <StyledTableCell align="right">N.O.K Tel</StyledTableCell>
